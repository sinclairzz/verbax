...
@pytest.mark.parametrize('rule,patch,expected',[
    ...
    ('aviso_previo',{'salario_base':'3000','anos_completos':5},'4500.00'),
...
],ids=['saldo_mes_inteiro','saldo_12_dias','aviso_0_anos','aviso_5_anos','aviso_teto_30_anos','ferias_12_meses','ferias_6_meses','decimo_12_meses','decimo_4_meses','multa_10000'])
...
def test_decimal_rounding_once_per_line(input_data):
    ...
    assert result['resultados'][0]['valor']=='438.07'
